...
data class CatalogProfileResponse(
    ...
    @field:Schema(description = "Peso por metro (kg/m) — almacenado manualmente")
    val weightKgM: BigDecimal?,
    @field:Schema(description = "Peso por metro calculado desde área × densidad del material (kg/m)")
    val calculatedWeightKgM: BigDecimal?,
    @field:Schema(description = "Área (cm²)")
    val areaCm2: BigDecimal?,
    @field:Schema(description = "Tipo de material")
    ...
    companion object {
        fun from(e: CatalogProfile) = CatalogProfileResponse(
            ...
            weightKgM = e.weightKgM,
            calculatedWeightKgM = e.getCalculatedWeightKgM(),
            areaCm2 = e.areaCm2,
