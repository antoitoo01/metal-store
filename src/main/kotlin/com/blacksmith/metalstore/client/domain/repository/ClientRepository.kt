...
interface ClientRepository : JpaRepository<Client, UUID> {
    ...
    fun findByOrganizationIdAndStatus(organizationId: UUID, status: ClientStatus, pageable: Pageable): Page<Client>
    fun findByOrganizationIdAndNameContainingIgnoreCase(organizationId: UUID, name: String, pageable: Pageable): Page<Client>
    fun findByOrganizationIdAndNameContainingIgnoreCaseAndStatus(organizationId: UUID, name: String, status: ClientStatus, pageable: Pageable): Page<Client>
